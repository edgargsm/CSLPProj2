...
///@file
/**
Beginning in (X,Y) pixel from SrcImage and (0,0) pixel from WaterMarkImg, will substitute each SrcImage Pixel for an average
of the the corresponding pixel from both images.
